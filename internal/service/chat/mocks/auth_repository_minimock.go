...
//go:generate minimock -i github.com/waryataw/chat-server/internal/service/chat.AuthRepository -o auth_repository_minimock.go -n AuthRepositoryMock -p mocks
